...
const MENUS = [
  {
    label: 'Case Actions',
    items: [
      { label: 'New Case', go: '#/case/new' },
      { label: 'Open / Search Cases', go: '#/worklist' },
      { sep: true },
      { label: 'Save Case', dummy: true },
      { label: 'Copy Case', dummy: true },
      { label: 'Delete Case', dummy: true },
      { sep: true },
      { label: 'Lock Case', dummy: true },
      { label: 'Route Case', dummy: true },
      { label: 'Close Case', dummy: true },
      { label: 'Print Case', dummy: true },
    ],
  },
  {
    label: 'Worklist',
    items: [
      { label: 'Cases', go: '#/worklist' },
      { label: 'New Cases (Intake)', dummy: true },
      { label: 'Action Items', dummy: true },
      { label: 'Coding Action Items', dummy: true },
      { label: 'Contacts', dummy: true },
      { label: 'Bulk Reporting', dummy: true },
      { label: 'Local Labeling', dummy: true },
    ],
  },
  {
    label: 'Reports',
    items: [
      { label: 'ICSR / E2B Reports', dummy: true },
      { label: 'Expedited Reports', dummy: true },
      { label: 'Periodic Reports (PBRER/PSUR)', dummy: true },
      { label: 'PADER', dummy: true },
      { label: 'Aggregate Reports', dummy: true },
      { label: 'Compliance Reports', dummy: true },
      { label: 'Case Data Analysis', dummy: true },
    ],
  },
  {
    label: 'Code Lists',
    items: [
      ...
      { label: 'WHO Drug Browser', dummy: true },
      { label: 'Business Configuration', dummy: true },
      { label: 'Flexible Data Re-Categorization', dummy: true },
    ],
  },
  {
    label: 'Utilities',
    items: [
      ...
      { label: 'Case Copy Configuration', dummy: true },
      { label: 'Logs', dummy: true },
      { label: 'Reconciliation', dummy: true },
    ],
  },
  {
    label: 'Argus Console',
    items: [
      ...
      { label: 'Business Configuration', dummy: true },
      { label: 'Audit Log', dummy: true },
    ],
  },
  {
    label: 'Help',
    items: [
      { label: 'About this Application', action: 'about' },
      { label: 'User Guide', dummy: true },
      { label: 'Argus Documentation', dummy: true },
    ],
  },
];
